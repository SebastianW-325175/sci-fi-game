...
func update_resources() -> void:
	idle_texture = load("res://Assets/Textures/Human/Base/"+skin+"/Arms/idle.png")
	left_forward_texture = load("res://Assets/Textures/Human/Base/"+skin+"/Arms/left_forward.png")
	right_forward_texture = load("res://Assets/Textures/Human/Base/"+skin+"/Arms/right_forward.png")
